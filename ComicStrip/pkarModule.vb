...
#Region "DialogBoxy"
    ...
    Public Async Function DialogBoxInput(sMsg As String, Optional sDefault As String = "", Optional sYes As String = "Continue", Optional sNo As String = "Cancel") As Task(Of String)
    ...
    Public Async Function DialogBoxInputRes(sMsgResId As String, Optional sDefaultResId As String = "", Optional sYesResId As String = "resDlgContinue", Optional sNoResId As String = "resDlgCancel") As Task(Of String)
        ...
        Return Await DialogBoxInput(sMsg, sDefault, sYes, sNo)
...
#End Region
    ...
    Public Async Function HttpPageAsync(sUrl As String, sErrMsg As String, bMsg As Boolean, Optional sData As String = "") As Task(Of String)
        Try
            ...
            If sError <> "" Then
                ...
                Else
                    CrashMessageAdd("@HttpPageAsync", "error " & sError & " at " & sErrMsg & " page")
                End If
                Return ""
            End If
            ...
            If oResp.StatusCode > 290 Then
                ...
                Else
                    CrashMessageAdd("@HttpPageAsync", "ERROR " & oResp.StatusCode & " getting " & sErrMsg & " page")
                End If
                Return ""
            End If
            ...
            If sError <> "" Then
                ...
                Else
                    CrashMessageAdd("@HttpPageAsync", "error " & sError & " at ReadAsStringAsync " & sErrMsg & " page")
                End If
                Return ""
            End If
