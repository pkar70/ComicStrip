...
' 2022.04.03: sync do pkarlibmodule
' 2022.04.03: przerzucenie czesci rzeczy do Extensions
' 2022.04.03: ProgRing, jako Extension do Page

' 2022.01.20: Get/SetSettings jako Extension dla paru typów (TextBlock, TextBox, ToggleButton, ToggleSwitch)
' 2022.01.20: SetSettingsLangString - GetLangString -> SetSettingsString (z UI thread dla background)
' 2022.01.20: ShowAppVers jako Extension dla Page oraz TextBlock, znika jako zwykły Sub
...
#Region "RemoteSystem/Background"
    ...
    Private Async Sub RemSysOnRequestReceived(sender As Windows.ApplicationModel.AppService.AppServiceConnection, args As Windows.ApplicationModel.AppService.AppServiceRequestReceivedEventArgs)
        ...
        If pkar.GetSettingsBool("remoteSystemDisabled") Then
...
#Region "String"
    ...
    Public Function SetSettingsString(sName As String, sValue As String, Optional bRoam As Boolean = False) As Boolean
        Try
...
#Region "Int"
    ...
    Public Sub SetSettingsInt(sName As String, sValue As Integer, Optional bRoam As Boolean = False)
        With Windows.Storage.ApplicationData.Current
...
#Region "Long"
    ...
    Public Sub SetSettingsLong(sName As String, sValue As Long, Optional bRoam As Boolean = False)
        With Windows.Storage.ApplicationData.Current
            If bRoam Then .RoamingSettings.Values(sName) = sValue.ToString
            .LocalSettings.Values(sName) = sValue.ToString
        End With
...
#Region "Bool"
    ...
    Public Sub SetSettingsBool(sName As String, sValue As Boolean, Optional bRoam As Boolean = False)
        With Windows.Storage.ApplicationData.Current
            If bRoam Then .RoamingSettings.Values(sName) = sValue.ToString
            .LocalSettings.Values(sName) = sValue.ToString
        End With
...
#Region "testy sieciowe"
    ...
    Public Function NetIsIPavailable(bMsg As Boolean) As Boolean
        ...
        ' NetworkInterface dopiero od .Net Std 2.0, .Net Core 1.0
    ...
    Public Function GetHostName() As String
        ' System.Net.Dns.GetHostName od .Net Std 2.0, .Net Core 1.0
...
#Enable Warning BC42358
    ...
    Public Function GetLangString(sMsg As String, Optional sDefault As String = "") As String
        ...
        If sDefault = "" Then sDefault = sMsg

        If mbNoResMap Then Return sDefault
    ...
    ''' <summary>
    ''' przepisanie z GetLang do Settings, by było i w Background (niepotrzebne w VBlib, bo tam działa i w Background)
    ''' </summary>
    Public Sub SetSettingsLangString(sName As String, Optional sDefault As String = "")
        SetSettingsString(sName, GetLangString(sName, sDefault))
    End Sub
...
#Enable Warning BC42358
    ...
    End Function
    Public Async Function DialogBoxInputAllDirectAsync(sMsg As String, Optional sDefault As String = "", Optional sYes As String = "Continue", Optional sNo As String = "Cancel") As Task(Of String)
...
#Region "Toasty itp"
    ...
    ''' <summary>
    ''' dwa kolejne teksty, sMsg oraz sMsg1; działa bez Builder oraz na bardzo starych Windows
    ''' </summary>
...
#Region "DataLog folder support"
    ...
    ' tylko z true wywołania bezpośrednie
...
#End Region
    ...
    ' libmodule: Public Function GetPlatform() As String
...
#End Region
    ...
    <Extension()>
    Public Sub OpenBrowser(byval oUri As Uri, optional bForceEdge As Boolean = false)
...
#Region "GPS odleglosci"
    ...
    ''' <summary>Czy punkt leży w miarę w Polsce (mniej niz 500 km od środka geometrycznego Polski)</summary>
    <Extension()>
    ...
    ' https://pl.wikipedia.org/wiki/Geometryczny_%C5%9Brodek_Polski
        ...
        Dim oSrodek as new Windows.Devices.Geolocation.BasicGeoposition
        oSrodek.Latitude = 52.2159333
        oSrodek.Longitude = 19.1344222
        Dim dOdl as double = oPos.DistanceTo(oSrodek)
...
#Region "Settingsy jako Extension"
    ...
    Public Sub GetSettingsString(ByVal oItem As TextBlock, Optional sName As String = "", Optional sDefault As String = "")
        ...
        Dim sTxt As String = pkar.GetSettingsString(sName, sDefault)
        oItem.Text = sTxt
    End Sub
    <Extension()>
    Public Function SetSettingsString(ByVal oItem As TextBlock, Optional sName As String = "", Optional bRoam As Boolean = False) As Boolean
        If sName = "" Then sName = oItem.Name
        Return pkar.SetSettingsString(sName, oItem.Text, bRoam)
    End Function
    ...
    End Sub
    <Extension()>
    Public Function SetSettingsString(ByVal oItem As TextBox, Optional sName As String = "", Optional bRoam As Boolean = False) As Boolean
        If sName = "" Then sName = oItem.Name
        Return pkar.SetSettingsString(sName, oItem.Text, bRoam)
    End Function
    ...
    Public Sub SetSettingsBool(ByVal oItem As ToggleButton, Optional sName As String = "", Optional bRoam As Boolean = False)
        If sName = "" Then sName = oItem.Name
        pkar.SetSettingsBool(sName, oItem.IsChecked, bRoam)
    End Sub
...
#End If
    ...
    Public Sub ShowAppVers(ByVal oPage As Page)
        ...
        If oGrid Is Nothing Then
            ...
            Debug.WriteLine("ShowAppVers(null) wymaga Grid jako podstawy Page")
            Throw New ArgumentException("ShowAppVers(null) wymaga Grid jako podstawy Page")
        End If
...
#Region "ProgressBar/Ring"
    ...
    Public Sub ProgRingInit(ByVal oPage As Page, bRing As Boolean, bBar As Boolean)
        ...
        If oPage.FindName("uiPkAutoProgRing") Is Nothing Then
            If bRing Then
                Dim _mProgRing As New ProgressRing
        ...
        If oPage.FindName("uiPkAutoProgBar") Is Nothing Then
            If bBar Then
                Dim _mProgBar As New ProgressBar
